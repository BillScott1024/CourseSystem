...
public class XiuGaiteacher {
private JFrame frame = new JFrame("个人信息");     //窗口名称
	
	private JLabel infoLab1 = new JLabel("教师信息修改");   //标题
...
//	private JLabel infoLab2 = new JLabel("用户名必须为6-16位字母或数字");    //提示一
	...
	private JLabel infoLab5 = new JLabel("修改成功！");    //提示四
	...
	private JLabel infoLabId = new JLabel("教师姓名：");
	private JLabel infoLabclass = new JLabel("职称：");
...
//	private JRadioButton girl = new JRadioButton("女");
	...
	private JButton regist = new JButton("修           改");
	
	int count1  = 0;
	public XiuGaiteacher(){
