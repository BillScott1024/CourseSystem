...
public class Selectclass implements ListSelectionListener{
	...
	private JButton regist = new JButton("确 认 选 课 ");
	
	public Selectclass(){
		Font fnt1 = new Font("Serief", Font.BOLD, 24);
		infoLab1.setFont(fnt1);
		//读数据库，设置查找条件,写入数组
		String nations[] = {"中国","美国","日本","韩国","泰国","英国","美国","日本","韩国","泰国","英国"
				,"美国","日本","韩国","泰国","英国","美国","日本","韩国","泰国","英国"
				,"美国","日本","韩国","泰国","英国","美国","日本","韩国","泰国","英国"
				,"美国","日本","韩国","泰国","英国","美国","日本","韩国","泰国","英国","美国","日本","韩国","泰国","英国"};
		this.list = new JList<String>(nations);
		list.setBorder(BorderFactory.createTitledBorder("所有课程："));
		list.setSelectionMode(ListSelectionModel.MULTIPLE_INTERVAL_SELECTION);
		list.addListSelectionListener(this);
		cont.add(new JScrollPane(this.list));           //滚动条
